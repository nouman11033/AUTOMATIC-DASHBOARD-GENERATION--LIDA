...
# Create 3 columns for side-by-side images
col1, col2, col3 = st.columns(3)

# Display the images in each column with captions
with col1:
...
st.markdown(
    ...
    ## **Problem Statement:**  
    **Traditional static dashboards lack the ability to identify, analyze, and curate personalized content autonomously, without external input from users.**

    To address this, there is a pressing need for adaptive, LLM-generative dashboards.

    ### **Said Advantage:**  
    These dashboards leverage advanced technologies to automatically gather, process, and analyze legal and compliance data, offering real-time insights and personalized recommendations—saving valuable time and resources.
    """
)
